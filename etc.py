...
num_epochs = 20  # 一共训练多少回合
max_step = radius * 2  # 每回合一共做多少次决策
...
distance_to_obs = 0.01  # 如果智能体到障碍物的距离小于这个值，则判定其碰到障碍
distance_to_target = 0.4  # 如果智能体到目标地点的距离小于这个值，则判定到达目标地点
view_agent = 0.01  # 智能体的视野
